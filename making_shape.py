...
target_gabor_index=random.randrange(0,gabor_ball.n_patches)
gratings[target_gabor_index].ori = gratings[target_gabor_index].ori + change_angle

def Change():
    global target_gabor_index
    gratings[target_gabor_index].ori = 0.
...
if save_video:
    win.saveMovieFrames('making_shape_' + ['','control'][is_control] + '.mp4', fps=40)
