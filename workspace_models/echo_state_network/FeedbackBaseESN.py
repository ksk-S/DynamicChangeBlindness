...
import scipy as sp
import progressbar
from easyesn import helper as hp
...
class BaseESN(object):
    ...
    # returns states, estimated output for untrained model
    # updates all variables only for 1 step
    ...
    #returns states (not _x reservoir), and ???y for untrained model
    ...
    """
        ...
        ------
        actually does not update the states at all.
        Modified: return both input and var that would represent updated states
    """
